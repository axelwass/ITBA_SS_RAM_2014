...
public class MemoryManager {
	...
	public HistogramInformation histogram(int range, long mamorySize, long time){
		HistogramInformation histo = new HistogramInformation(range, mamorySize, time/1000);
		for(Bin bin: bins){
