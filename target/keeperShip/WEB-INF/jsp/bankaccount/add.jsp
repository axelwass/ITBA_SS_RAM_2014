...
<h2>Ingresar cuenta de banco</h2>
...
<form:form class="form-horizontal" method="POST" action="add"
	...
	<fieldset>
		<div class="control-group">
			<label class="control-label" for="bankName">(*)Nombre de cuenta: (memo) </label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="bankName">Número de cuenta: </label>
			<div class="controls">
