...
//		System.out.println(req.getRequestURI());
		if(req.getRequestURI().matches(".*/bin.*") || req.getRequestURI().matches(".*/css.*") || req.getRequestURI().matches(".*/imgs.*")|| req.getRequestURI().matches(".*/js.*")){
...
//			System.out.println("restrictedFilter: antes de sendredirect");
			resp.sendRedirect("/zonaProp/bin/user/login");
		}
	}
